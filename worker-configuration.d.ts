/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 7ee17c7a814324a4f6a11ea0f70cf540)
...
interface __BaseEnv_CloudflareBindings {
	...
	ASSET_METRICS: AnalyticsEngineDataset;
	FLAGS: Flagship;
	ASSET_PROXY_RATE_LIMITER: RateLimit;
	OBSERVABILITY_REPORT_LEVEL: "off";
	ASSET_COORDINATOR_BUDGET_VERIFIED: "false";
	ASSET_COORDINATOR_SHARDS: "16";
	ASSET_COORDINATOR_CONCURRENCY: "1";
	ASSET_COORDINATOR_QUEUE_LIMIT: "32";
	ASSET_COORDINATOR_PERMIT_INTERVAL_MS: "1000";
	ASSET_COORDINATOR_FALLBACK_COOLDOWN_SECONDS: "30";
	ASSET_COORDINATOR_OPERATION_DEADLINE_MS: "25000";
	ASSET_COORDINATOR_RETRY_BASE_MS: "250";
	ASSET_LEGACY_V1_READ_UNTIL: "2026-09-01T00:00:00.000Z";
	ROBLOX_API_KEY: string;
	ASSET_RESOLUTION_COORDINATOR: DurableObjectNamespace<import("./src/index").AssetResolutionCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AssetResolutionCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OBSERVABILITY_REPORT_LEVEL" | "ASSET_COORDINATOR_BUDGET_VERIFIED" | "ASSET_COORDINATOR_SHARDS" | "ASSET_COORDINATOR_CONCURRENCY" | "ASSET_COORDINATOR_QUEUE_LIMIT" | "ASSET_COORDINATOR_PERMIT_INTERVAL_MS" | "ASSET_COORDINATOR_FALLBACK_COOLDOWN_SECONDS" | "ASSET_COORDINATOR_OPERATION_DEADLINE_MS" | "ASSET_COORDINATOR_RETRY_BASE_MS" | "ASSET_LEGACY_V1_READ_UNTIL" | "ROBLOX_API_KEY">> {}
}
declare module "*.wasm" {
