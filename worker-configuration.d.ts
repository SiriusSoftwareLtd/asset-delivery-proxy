/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: afbe2e064567eb274155fcb6f64dc93d)
...
interface __BaseEnv_CloudflareBindings {
	...
	OBSERVABILITY_REPORT_LEVEL: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OBSERVABILITY_REPORT_LEVEL">> {}
}
declare module "*.wasm" {
