/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: ff99f7ab19b56beae982c262c30a3533)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OBSERVABILITY_REPORT_LEVEL" | "ROBLOX_API_KEY">> {}
}
declare module "*.wasm" {
